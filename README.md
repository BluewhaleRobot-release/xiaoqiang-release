...
## xiaoqiang (kinetic) - 0.0.10-0

The packages in the `xiaoqiang` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release xiaoqiang --track kinetic --rosdistro kinetic` on `Sat, 09 Jun 2018 13:19:13 -0000`
...
## xiaoqiang (kinetic) - 0.0.9-0

The packages in the `xiaoqiang` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release xiaoqiang --track kinetic --rosdistro kinetic` on `Thu, 07 Jun 2018 06:20:09 -0000`
